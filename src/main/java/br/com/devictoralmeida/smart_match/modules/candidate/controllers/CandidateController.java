...
public class CandidateController {
  ...
  public ResponseEntity<Object> create(@Valid @RequestBody CandidateEntity candidateData) {
    try {
      var result = createCandidateUseCase.execute(candidateData);
  ...
  public ResponseEntity<Object> getProfile(HttpServletRequest request) {
    ...
    try {
      var candidate = profileCandidateUseCase.execute(convertedCandidateId);
  ...
  public ResponseEntity<Object> applyJob(HttpServletRequest request, @RequestBody UUID idJob) {
    ...
    try {
      var result = applyJobCandidateUseCase.execute(convertedCandidateId, idJob);
      return ResponseEntity.ok().body(result);
    } catch (Exception e) {
      return ResponseEntity.badRequest().body(e.getMessage());
    }
